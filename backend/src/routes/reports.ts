    ...
    switch (report_type) {
      ...
      case 'Academic':
        ...
        reportData = {
          ...
          major_subjects_enrolled: latestAcademic?.major_subjects_enrolled || 0,
          major_subjects_passed: latestAcademic?.major_subjects_passed || 0,
          major_subjects_failed: latestAcademic?.major_subjects_failed || 0,
  ...
  try {
    ...
    const sampleReports = [
      ...
      },
      {
        ...
        generated_by: 'counselor@sjc.edu.ph',
        status: 'Generated',
        data: { gpa: 3.2, subjects: 6, improvements: 2 },
      },
      {
